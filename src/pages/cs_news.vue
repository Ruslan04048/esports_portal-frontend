  ...
  <div class="category-page">
    ...
    <div class="search-fields">
      <div class="search-block">
        <input class="search-title" v-model="searchTitle" type="text" placeholder="Поиск по названию…" />
        ...
        <div class="news-body">
          ...
          <div class="comments-panel">
            <div v-for="c in post.recent_comments" :key="c.id" class="comment">
              <img class="avatar" :src="c.user?.avatar_url || '/default-avatar.png'" alt="avatar" />
              <div>
                <p>
            ...
            <div v-if="auth.token && auth.user" class="new-comment">
              <textarea v-model="newBodies[post.id]" placeholder="Оставить комментарий…" rows="2"></textarea>
              <button :disabled="!newBodies[post.id]?.trim()" @click="submitComment(post.id)">
                Отправить
              </button>
            </div>
