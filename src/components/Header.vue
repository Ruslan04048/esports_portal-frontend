  ...
  <header class="header">
    <div class="header_items">
      <div class="header_left">
        <div class="logo">
          <RouterLink to="/"><img src="../assets/images/logo.svg" alt="logo" width="50" /></RouterLink>
      ...
      <div v-else class="header_right">
        <RouterLink v-if="isAuthenticated" to="/profile"><img src="../assets/images/profile.svg" alt="avatar"
            width="30" /></RouterLink>
