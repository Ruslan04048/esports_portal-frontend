  ...
  <div class="admin-wrapper">
    ...
    <div class="form-card">
      ...
      <form v-if="addNews" @submit.prevent="addPost" class="form" enctype="multipart/form-data">
        <input v-model="newPost.title" type="text" placeholder="Заголовок" class="form-input" />
        <textarea v-model="newPost.body" placeholder="Описание" class="form-textarea"></textarea>
        <div class="btn-group">
    ...
    <div class="product-grid">
      <div v-for="post in postStore.posts" :key="post.id" class="product-card">
        <div class="product-header">
          <img class="dota-icon" :src="post.category === 'dota' ? dotaIcon : csIcon" alt="icon" width="40" />
    ...
    <div v-if="isEditing" class="modal-overlay">
      <div class="modal">
        ...
        <form @submit.prevent="updatePost" class="form" enctype="multipart/form-data">
          <input v-model="editedPost.title" type="text" placeholder="Заголовок" class="form-input" />
          <textarea v-model="editedPost.body" placeholder="Описание" class="form-textarea"></textarea>
    ...
    <div class="user-grid">
      ...
      <div v-for="u in users" :key="u.id" class="user-card">
        ...
        <div class="btn-group">
          <button @click="toggleBan(u.id)" :class="['btn_ban', u.banned ? 'btn-unban' : 'btn-ban']">
